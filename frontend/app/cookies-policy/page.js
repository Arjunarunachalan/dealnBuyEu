...
export default function CookiesPolicy() {
  const [data, setData] = useState({ title: "Cookies & Tracking Policy", sections: [] });
  ...
  useEffect(() => {
    const fetchPageData = async () => {
      try {
        const response = await axios.get(`${API_URL}/legal-pages/cookies`);
  ...
  return (
    <LegalLayout activePage="cookies">
